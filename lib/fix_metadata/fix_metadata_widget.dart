...
class FixMetadataWidget extends StatefulWidget {
  const FixMetadataWidget({
    super.key,
    this.docRefMovie,
    this.docRefSeries,
  ...
  static String routeName = 'FixMetadata';
  static String routePath = '/fixMetadata';

  @override
  State<FixMetadataWidget> createState() => _FixMetadataWidgetState();
}

class _FixMetadataWidgetState extends State<FixMetadataWidget> {
  late FixMetadataModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FixMetadataModel());
