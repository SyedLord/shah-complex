...
class _CollectionPageWidgetState extends State<CollectionPageWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Builder(
      builder: (context) => StreamBuilder<List<MovieCollectionsRecord>>(
        ...
        builder: (context, snapshot) {
          ...
          List<MovieCollectionsRecord>
              collectionPageMovieCollectionsRecordList = snapshot.data!;
          final collectionPageMovieCollectionsRecord =
              collectionPageMovieCollectionsRecordList.isNotEmpty
                  ? collectionPageMovieCollectionsRecordList.first
                  : null;
                        ...
                        child: Stack(
                          children: [
                            CachedNetworkImage(
                              ...
                              imageUrl: collectionPageMovieCollectionsRecord!
                                  .backdropImage,
                                    ...
                                    children: [
                                      wrapWithModel(
                                        ...
                                        child: MovieCardWidget(
                                          img:
                                              collectionPageMovieCollectionsRecord
                                                  .posterImage,
                                        ),
                                      ),
                                      Column(
