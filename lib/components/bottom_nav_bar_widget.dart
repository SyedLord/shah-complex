        ...
        child: StreamBuilder<List<AppConfigRecord>>(
          stream: queryAppConfigRecord(
            singleRecord: true,
              ...
              List<AppConfigRecord> bottomNavBarAppConfigRecordList = snapshot;
              final bottomNavBarAppConfigRecord =
                  bottomNavBarAppConfigRecordList.isNotEmpty
                      ? bottomNavBarAppConfigRecordList.first
                      : null;
              if (_model.bottomNavBarPreviousSnapshot != null &&
                  !const ListEquality(AppConfigRecordDocumentEquality()).equals(
                ...
                () async {
                  ...
                  FFAppState().clearNewsCountAllCache();
                  FFAppState().clearNewsTrendingCardsCache();
                  FFAppState().clearNewsCardsAllCache();

                  safeSetState(() {});
                }();
              }
              _model.bottomNavBarPreviousSnapshot = snapshot;
            }),
          builder: (context, snapshot) {
            ...
            List<AppConfigRecord> bottomNavBarAppConfigRecordList =
                snapshot.data!;
            ...
            return ClipRRect(
              ...
              child: BackdropFilter(
                ...
                child: FutureBuilder<ProfilesRecord>(
                  future: FFAppState().profileCache(
                    requestFn: () => ProfilesRecord.getDocumentOnce(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final bottomNavProfilesRecord = snapshot.data!;

                    return Container(
                      decoration: BoxDecoration(
                        color: Color(0x4F141414),
                      ),
                      child: Padding(
